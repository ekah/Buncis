...
namespace Buncis.Web.WebServices.Contracts
{
	...
	public interface INews
	{
		...
		[OperationContract]
		[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
		Response<IEnumerable<DtoBuncisNewsCategory>> BPGetNewsCategories(int clientId);

		[OperationContract]
		[WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json)]
		Response<DtoBuncisNewsCategory> BPInsertNewsCategory(int clientId, DtoBuncisNewsCategory newsCategory);
